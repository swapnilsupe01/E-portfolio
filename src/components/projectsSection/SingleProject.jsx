...
//         {/* ✅ View Button (Now Clickable & Opens GitHub) */}
//         <a
//           href={link}
//           target="_blank"
...
//       >
//         {/* ✅ Fixed Click Blocking Issue by Removing Overlay */}
//         <div className="absolute top-0 left-0 w-full h-full bg-cyan opacity-50 hover:opacity-0 transition-all duration-500 md:block sm:hidden"></div>
...
const SingleProject = ({ name, year, align, image, link }) => {
  return (
    ...
    >
      ...
      {/* ✅ Clickable Image (Navigates to GitHub) */}
      <a
        href={link}
        target="_blank"
        rel="noopener noreferrer"
        className="max-h-[220px] max-w-[400px] rounded-xl overflow-hidden hover:scale-110 transform transition-all duration-500 relative border border-white"
      >
        {/* ✅ Fix: Removed Overlay Block Click */}
        <div className="absolute top-0 left-0 w-full h-full bg-cyan opacity-50 hover:opacity-0 transition-all duration-500 md:block sm:hidden"></div>
